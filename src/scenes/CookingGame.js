...
export default class CookingGame extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('raw','assets/rawFood.png')
        this.load.image('half','assets/halfFood.png')
        this.load.image('flip','assets/halfFlipFood.png')
        this.load.image('well','assets/wellFood.png')
        this.load.image('panel','assets/cookpanel.png')
        this.load.image('cookSpot','assets/cookSpot.png')
        this.load.image('foodCan','assets/foodCan.png')
